...
2. Drag `Monster Expedition.app` into `/Applications` and open it once.
...
The game works without step 5. The Helper is an accessory process: it has no Dock icon and should not take keyboard focus.
