...
4. If the tool returns a text snapshot without a widget, explain that the Codex MCP App host feature is disabled; do not claim the game opened. Direct the user to enable MCP Apps and fully restart Codex before trying again.
